...
foreach ($arr as $kol => $arr_obj) {
    ...
    if ($kol <= 4) {
        $all_names .= '<div class="wa">
                <div class="str"></div>
                <div style="font-size:1rem;">' . $day . ' ' . $mth . '</div><b>' . $arr_obj->name . '</b>, ' . $arr_obj->age . ' ' . $let . ' 
                <!-- <div class="time">08:00</div>-->
            </div>';
    }
    if ($kol == 0) $arr_pictures .= '<img src="' . $arr_obj->vertical_url . '" alt="" border="0" style="width:270px;"/>';
    else $arr_pictures .= '<img src="' . $arr_obj->vertical_url . '" alt="" border="0" style="width:270px;display:none;"/>';
    //print_r($arr_obj);
}
echo '</pre>';
    ...
    <div class="large-5 medium-5 columns">
        ...
        <div class="orient">
            ...
            <div style="text-align: center;">
                ...
                <div class="orient_div" id="slideshow" style="text-align: center;"><center>
                    <?= $arr_pictures ?>
                    </center>
                </div>
            </div>
